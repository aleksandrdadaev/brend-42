...
import { useDeleteHowParticipate } from '@/features/delete-how-participate'
...
const Manage: FC<{ id: string }> = ({ id }) => {
	...
	const { isPending, mutate } = useDeleteHowParticipate()
	return (
		<ManageButtons>
			<EditButton
				clickHandler={() => push(getManageUrl(`/how-to-accept/edit/${id}`))}
				disabled={isPending}
			/>
